...
function faveColorFinder(color){
  if( color === "red"){
  return "the most famous color"
  }else if (color === "green"){
   return "green is super solid,and its the best power ranger color"
  }else if(color === "black"){
    return "soo edgy, dont cut urself"
  }else{
    return "you need to think about your color choices"
  }
}
let colorRating = faveColorFinder("iron")
...
let roster = theEliminator(contestants, loser)
console.log(roster)
////////////////// PROBLEM 11 ////////////////////
...
function uppercase(sampleString){
  // let grammar = String(sampleString.toUpperCase());
 console.log(sampleString.toUpperCase());
}
const hiya = uppercase(sampleString)
console.log(hiya);
////////////////// PROBLEM 12 ////////////////////
/*
...
*/
let email = " MahadAbdishakur@gmail.com "
...
//CODE HERE
function ripbit(spend){
  if(spend > 3){
    return spend / 3
  }else{
    return "get your money up bud"
  }
}
let sum = ripbit(9)
console.log(sum)
...
//CODE HERE
// function isOddOrEvens(odd-even){
// if(num % 2 === 0){
//   return true
// }else{
//   return false
